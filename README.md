...
* (India) [GRID MAP OF KARNATAKA](https://web.archive.org/web/20220802124435/https://kptcl.karnataka.gov.in/storage/pdf-files/epra/1%20GRIDMAP_2018.pdf)
...
* (France) [Structural french grid data with detailed topology time series](https://huggingface.co/datasets/OpenSynth/D-GITT-RTE7000-2021) (cc-by-sa-4.0)
...
* (Brazil) [Harmonized and Open Energy Dataset for Modeling a Highly Renewable Brazilian Power System](https://zenodo.org/records/7478165) (cc-by-4.0) (dataset)
